                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            while($row = mysqli_fetch_assoc($select_comments)){
                                ...
                                echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete?'); \" href='./post_comment.php?delete=$comment_id&id=" . mysqli_real_escape_string($connection, $_GET['id']) . "'>Delete</a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
